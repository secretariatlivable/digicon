...
const en: Record<TranslationKey, string> = {
  ...
  'landing.hero.subtitle': 'The all-in-one digital business card and CRM platform built for Philippine SMEs and startups.',
  ...
  'landing.crm.desc': 'Auto-sync contacts to HubSpot. Export to CSV. Capture leads with consent built-in.',
  ...
  'landing.localized.title': 'Built for the Philippines',
...
const fil: Record<TranslationKey, string> = {
  ...
  'landing.hero.subtitle': 'Ang all-in-one digital business card at CRM platform para sa mga SME at startup sa Pilipinas.',
  ...
  'landing.localized.title': 'Ginawa para sa Pilipinas',
