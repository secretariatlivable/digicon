      ...
      <div className="mx-auto max-w-5xl px-4 py-12">
        <div className="text-center">
          ...
          <p className="dense mx-auto mt-3 max-w-xl text-muted-foreground">
            Use the core relationship workspace for free. Upgrade when DigiCon
            becomes the system of record for your professional network.
          </p>
        </div>
        ...
        >
          ...
          <p
            ...
            className="dense mt-3 max-w-3xl text-sm leading-6 text-muted-foreground"
          >
            Choose a DigiCon PayPal subscription and complete approval on
            PayPal. Your paid access is activated only after DigiCon verifies
            the PayPal webhook.
          </p>
