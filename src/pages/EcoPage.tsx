...
import { Award, Leaf, TreePine, Factory, Sparkles, TrendingUp, Users, Network, RefreshCw, Star } from 'lucide-react';
    ...
    <AppLayout>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {[
          ...
          <GlassCard key={i} variant="regular" hover className="p-5 text-center animate-fade-in-up">
